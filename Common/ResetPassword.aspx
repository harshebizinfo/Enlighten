<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="LMS.Common.ResetPassword" %>
    ...
    <form id="form1" class="user" runat="server">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txtOldPassword" CssClass="form-control" placeholder="Enter Your Old Password" class="form-control form-control-user" runat="server" TextMode="Password"></asp:TextBox>

                                                <asp:Label ID="lblErrOldPassword" CssClass="help-block" runat="server" Text="" ForeColor="White"></asp:Label>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                        ...
                                        <asp:Button ID="btnResetPassword" CssClass=" btn-user btn-block" Text="Reset Password" style="background-color:#d4f0fd;color:#000;width: 100%" OnClientClick="return FunForLoginValidation()" runat="server" OnClick="btnResetPassword_Click" />  
        ...
        <script>  
            function FunForLoginValidation() {
                var objValid = true;
                var objOldPassword = $("[id$=txtOldPassword]").val();
                var objNewPassword = $("[id$=txtNewPassword]").val();
                var objConNewPassword = $("[id$=txtConNewPassword]").val();
                if (objOldPassword == "") {
                    $('[id$=lblErrOldPassword]').text("Old Password is required");
                    $('[id$=lblErrOldPassword]').css("color", "#FF0000");
                    $("[id$=txtOldPassword]").addClass("Error-control");
                    objValid = false;
                }
                else {
                    $('[id$=lblErrOldPassword]').text("");
                    $('[id$=lblErrOldPassword]').css("color", "#FFFFFF");
                    $("[id$=txtOldPassword]").removeClass("Error-control");
                }
