<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterUser.aspx.cs" Inherits="LMS.Common.RegisterUser" %>
    ...
    <form id="form1" class="user" runat="server">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txtLastName" CssClass="form-control" placeholder="Enter Instutute Name" class="form-control form-control-user" runat="server"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <asp:TextBox ID="txtpermanentAddress" CssClass="form-control" Rows="3" placeholder="Enter Permanent Address" class="form-control form-control-user" runat="server"></asp:TextBox>

                                                <asp:Label ID="lblErrpermanentAddress" CssClass="help-block" runat="server" Text="" ForeColor="White"></asp:Label>
                                            </div>
                                        </div>
        ...
        <script>  
            function FunForLoginValidation() {
                ...
                var objpermanentAddress = $("[id$=txtpermanentAddress]").val();
                if (objFirstName == "") {
                ...
                if (objContactNumber == "") {
                    $('[id$=lblErrContactNumber]').text("Contact Number is required");
                ...
                if (objpermanentAddress == "") {
                    $('[id$=lblErrpermanentAddress]').text("Permanent Address is required");
                    $('[id$=lblErrpermanentAddress]').css("color", "#FF0000");
                    $("[id$=txtpermanentAddress]").addClass("Error-control");
                    objValid = false;
                }
                else {
                    $('[id$=lblErrpermanentAddress]').text("");
                    $('[id$=lblErrpermanentAddress]').css("color", "#FFFFFF");
                    $("[id$=txtpermanentAddress]").removeClass("Error-control");
                }
                return objValid;
            }
