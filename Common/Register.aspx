<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="LMS.Common.Register" %>
    ...
    <form id="form1" class="user" runat="server">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txtFirstName" CssClass="form-control" placeholder="Enter First Name" class="form-control form-control-user" runat="server"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txtLastName" CssClass="form-control" placeholder="Enter Last Name" class="form-control form-control-user" runat="server"></asp:TextBox>
        ...
        <script>  
            function FunForLoginValidation() {
                ...
                if (objFirstName == "") {
                    $('[id$=lblErrFirstName]').text("First Name is required");
                ...
                if (objLastName == "") {
                    $('[id$=lblErrLastName]').text("Last Name is required");
