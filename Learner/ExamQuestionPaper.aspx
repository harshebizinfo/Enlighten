<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamQuestionPaper.aspx.cs" Inherits="LMS.Learner.ExamQuestionPaper" %>
...
<body onkeydown="return (event.keyCode != 116)">
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Width="400px" Style="display: none; background-color: white; padding-top: 10px; padding-left: 0px; border: 5px solid white; border-radius: 20px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
            <div style="padding: 10px; box-shadow: 5px 10px 18px #888888; text-align: center; width: 390px">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8" align="right">
                        <%--<asp:Button ID="btnUpdate" CssClass="btn btn-success float-end" BackColor="#28a745" BorderColor="Black" ForeColor="White" CommandName="Update" runat="server" Text="Update" OnClick="btnUpdate_Click" />--%>
            ...
            <div style="padding: 10px; box-shadow: 5px 10px 18px #888888; text-align: center; width: 390px">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8" align="left">
                        ...
                        <asp:Button ID="Button4" runat="server" Text="OK" class="btn btn-danger float-end" BorderColor="Black" ForeColor="White" />
                    </div>
                </div>
            </div>
        </asp:Panel>
<asp:Label runat="server" Text="Label" Id="lblmultiViewActiveIndexId"></asp:Label>
    </form>
    <script>
    window.addEventListener('blur', function (e) {
        debugger;
        var value = '<%= ViewState["multiViewActiveIndexId"].ToString() %>';
        if (value != '2') {
