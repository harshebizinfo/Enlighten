...
{
    public partial class RazorFundTransferSuccessNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    string clientids=Session["ClientID"].ToString();
                    dt = new DataTable();
                    postinamount = "0";
                    ...
                    try
                    {
                        ...
                        Razorpay.Api.Payment payment = client.Payment.Fetch(postingmer_txn);
                        ...
                        clientid= (string)jUser["clientId"];
