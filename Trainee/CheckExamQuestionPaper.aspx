<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/Exam.master" AutoEventWireup="true" CodeBehind="CheckExamQuestionPaper.aspx.cs" Inherits="LMS.Trainee.CheckExamQuestionPaper" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12 justify-content-center">
            <center>
                <h2>Student's Question Paper</h2>
            </center>
        </div>
    </div>
    <div class="row">
        ...
        ShowHeaderWhenEmpty="True" PageSize="50" style="text-align:center" class="table table-bordered"
          AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging"  OnRowDataBound="GridView1_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="VIew File" ItemStyle-Width="100">
                        <ItemTemplate>
                            <asp:Button ID="btnDelete" runat="server" Text="VIew All File" OnClick="imgbtn_Click" Visible='<%# Eval("QuestionAnswerTypeId").ToString() == "3" ? true : false %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
...
<div class="row" style="margin:0px 0px -20px 0px">
                    ...
                    BorderWidth="3px" CellPadding="3" ShowHeaderWhenEmpty="True" Width="100%" OnRowCommand="gvFiles_RowCommand" OnRowDataBound="GridView2_RowDataBound">
                    <Columns>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <ItemTemplate>
                <%--<asp:HyperLink runat="server" NavigateUrl='<%# Eval("FilePath") %>' CommandName="Download" CausesValidation="False" CommandArgument='<%# Eval("FilePath") %>'
                    Text='Answer' />--%>
              ...
              <%--  <asp:LinkButton ID="lnkDownload" runat="server" CausesValidation="False" CommandArgument='<%# Eval("FilePath") %>'  
                ...
                <%--<a href='<%# Eval("FilePath") %>'>Answer  <asp:Label ID="Label2" runat="server" Text='<%# Eval("Id") %>'></asp:Label></a>--%>
           <%-- </ItemTemplate>
        </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
