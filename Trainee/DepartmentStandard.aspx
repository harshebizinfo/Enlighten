<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/DepartmentStandard.master" AutoEventWireup="true" CodeBehind="DepartmentStandard.aspx.cs" Inherits="LMS.Trainee.DepartmentStandard1" %>
...
<div class="col-md-flex">
            ...
            <div class="col-sm-flex"><%--<asp:Button ID="btnListDelete" CssClass="btn btn-primary" runat="server" Text="Delete" OnClick="btnListDelete_Click"/>&nbsp;&nbsp;&nbsp;--%>
                    <%--</div>--%>
                    <!-- The Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color:#bae7e3">
                                    <span Font-Size="Medium" color="black"><b>Add Department / Standard</b></span>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtDepartmentName" runat="server" placeholder="Department / Standard Name"></asp:TextBox>
                                    </div>
                                    <div class="mb-3">
...
<div class="row" style="margin:0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color:#bae7e3">
                               <table>
                                <tr>
                                <td height="50px"> <span Font-Size="Medium" color="black"><b>Update Department / Standard</b></span> </td>
                                </tr>
                                </table>
                             </div>
                        </div>
 ...
 <div class="row" style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color:#bae7e3">
                               <table>
                                <tr>
                                <td height="50px"> <span Font-Size="Medium" color="black"><b>Delete Department / Standard</b></span> </td>
                                </tr>
                                </table>
                             </div>
                        </div>
                   <div style=" padding: 10px;box-shadow: 0px 0px 0px #888888;text-align:center;width:390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="center" >
                               <br>
<asp:Label runat="server" ID="lblDeletTraineeDepartmentId" Text="Label" Visible="false"></asp:Label>
                             </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="center" >
