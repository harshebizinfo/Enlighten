...
namespace LMS.Trainee
{
    public partial class CourseList : System.Web.UI.Page
    {
        ...
        private void BindGrid(string p)
        {
            ...
            dt = bll.GetCourseSubjectUnderDepartmentStandardList("Trainee");
            DataView DataView = dt.DefaultView;
            DataView.RowFilter = "CourseSubjectName LIKE '%" + search + "%'  OR DepartmentStandardName LIKE '%" + search + "%'";
            GridView1.DataSource = DataView;
            GridView1.DataBind();
            ViewState["data"] = dt;
        }
        public void bindaddCourseddl()
        {
            DataTable dt = new DataTable();
        ...
        public void bindupdateCourseddl()
        {
            DataTable dt = new DataTable();
            dt = deptbll.GetDepartmentStandardUnderTraineeList("Teacher");
        ...
        public void bindaddSubjectddl()
        {
            ...
            ddladdCourse.DataBind();
            ddladdCourse.Items.Insert(0, new ListItem("-- Select Subject --", "0"));
        }
        public void bindupdateSubjectddl()
        {
            ...
            ddlupdateCourse.DataBind();
            ddlupdateCourse.Items.Insert(0, new ListItem("-- Select --", "0"));
        }
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Course / Subject cannot be empty')", true);
                }
                else
                {
                    if (int.Parse(ddladddept.SelectedValue) != 0)
                    {
                        ...
                        // {
                        var result = bll.AddNewCourseSubject(int.Parse(ddladdCourse.SelectedValue), ddladdCourse.SelectedItem.Value.ToString(), int.Parse(ddladddept.SelectedValue.ToString()), isPublished);
                        if (result > 0)
                        {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                int id = int.Parse(lblDeleteTraineeCourseId.Text);
