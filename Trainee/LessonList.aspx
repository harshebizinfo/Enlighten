<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/Lesson.master" AutoEventWireup="true" CodeBehind="LessonList.aspx.cs" Inherits="LMS.Trainee.LessonList" %>
                    ...
                    <div style=" padding: 10px;box-shadow: 0px 0px 0px #888888;text-align:center;width:390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="center" >
                               <br>
                        <asp:Label runat="server" ID="lblDeleteTraineeLessonId" Text="Label" Visible="false"></asp:Label>
                             </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="center" >
