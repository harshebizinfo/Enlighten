<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/Lesson.master" AutoEventWireup="true" CodeBehind="AddLesson.aspx.cs" Inherits="LMS.Trainee.AddLesson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <asp:Button ID="btnOverview" runat="server" class="btn btn-primary" Text="Overview" OnClick="btnOverview_Click" />
                <asp:Button ID="btnDetails" runat="server" class="btn btn-primary" Text="Details" OnClick="btnDetails_Click" />
                <asp:Button ID="btnScheduleClass" runat="server" class="btn btn-primary" Text="Schedule Class" OnClick="btnScheduleClass_Click" />
                <asp:Button ID="btnAssignment" runat="server" class="btn btn-primary" Text="Assignments" OnClick="btnAssignment_Click" />
                <%--<asp:Button ID="btnHistory" runat="server" class="btn btn-primary" Text="History" OnClick="btnHistory_Click" />--%>
                                        ...
                                        <asp:View ID="Video" runat="server">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <label>Department/ Standard</label>
                                                    <div class="form-group">
                                                        <asp:DropDownList class="form-control" ID="ddlVideoDepartment" runat="server" AutoPostBack="True">
                                                        </asp:DropDownList>
                                                    </div> 
                                                </div>--%>
                                                <div class="col-sm-12">
                                        ...
                                        <asp:View ID="OtherDocuments" runat="server">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <label>Department/ Standard</label>
                                                    <div class="form-group">
                                                        <asp:DropDownList class="form-control" ID="ddlDriveDepartment" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDriveDepartment_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList class="form-control" ID="ddlSessionDepartment" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSessionDepartment_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <label></label>
                                    <div class=""> 
                                        <asp:Button class="btn btn-block" width="150px" ID="btnAssignmentSearch" runat="server" ValidationGroup="AssignmentList" Style="background-color: #28a745; color: #fff" Text="Search" OnClick="btnAssignmentSearch_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
