<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/Lesson.master" AutoEventWireup="true" CodeBehind="AddNewSession.aspx.cs" Inherits="LMS.Trainee.AddNewSession" %>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-12">
                                                    <%--<asp:ListBox ID="ListBox1" runat="server" style="max-height:500px" ></asp:ListBox>--%>
                                                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" Enabled="false" CssClass="rbListWrap" style="overflow:scroll;max-height:500px;" ></asp:CheckBoxList>
                                                </div>
                                            </div>
         ...
         <div class="row">
             <div class="col-sm-4">
                ...
                <div class="form-group">
                    <asp:DropDownList ID="ddlDepartment" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" Text="Select Department" InitialValue="0" ControlToValidate="ddlDepartment" ValidationGroup="event" runat="server" ForeColor="Red" />
                </div>
            </div>
             <div class="col-sm-4">
                 <label>Student Included In Session :</label>
                 <div class="form-group">
        ...
        <div class="row">
           ...
           <%-- <div class="col-sm-4">
            ...
            <div class="col-sm-2">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-6"><asp:CheckBox ID="chkPopup" runat="server" Text="PopUp" /></div>
                        <div class="col-sm-6"><asp:CheckBox ID="chkEmail" runat="server" Text="Email" /></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <asp:DropDownList ID="DropDownList5" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged" class="form-control">
                        <asp:ListItem Text="Select Frequency" Value="1" />
                        <asp:ListItem Text="Does Not Repeat" Value="DOESNOTREPEAT" />
             ...
             <div class="col-sm-2"></div>
              <b>Enter EmailId</b>
              <div class="col-sm-4" style="overflow:scroll;max-height:200px">
                    ...
                    <asp:View ID="View1" runat="server">
                     ...
                     <asp:View ID="View2" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox ID="txtCount" runat="server" CssClass="form-control" placeholder="Enter Number Of Days" autocomplete="off" TextMode="Number"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-md-flex">
                <div class="form-group">
                    ...
                    <asp:Button ID="btnSubmit" Width="150px"  runat="server" class="btn btn-block" Text="Submit" Style="background-color: #28a745; color: #fff" OnClientClick="ValidateAge()" ValidationGroup="event" OnClick="Button1_Click" />
