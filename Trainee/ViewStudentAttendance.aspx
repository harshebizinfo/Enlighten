<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/AttendanceMaster.master" AutoEventWireup="true" CodeBehind="ViewStudentAttendance.aspx.cs" Inherits="LMS.Trainee.ViewStudentAttendance" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <%--<Columns>
                            ...
                            <asp:TemplateField HeaderText="Attendance">
                                <ItemTemplate>
                                    <asp:Label ID="lblAttendance" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Attandence") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="AttendanceDate" HeaderText="AttendanceDate" DataFormatString="{0:dd/MM/yyyy}" />
                        </Columns>--%>
                        <EmptyDataTemplate>
