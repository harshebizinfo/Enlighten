<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/AttendanceMaster.master" AutoEventWireup="true" CodeBehind="UpdateStudentAttendance.aspx.cs" Inherits="LMS.Trainee.UpdateStudentAttendance" %>
     ...
     <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtDate" class="form-control" runat="server" placeholder="Select Attendance DateTime" AutoPostBack="true" OnTextChanged="txtDate_TextChanged1"></asp:TextBox>
