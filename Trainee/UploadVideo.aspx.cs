    ...
    public partial class UploadVideo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                btnVideoInPL.BackColor = _color;
                btnVideoInPL.ForeColor = _otherbackcolor;
        ...
        protected void btnViewPlayList_Click(object sender, EventArgs e)
        {
            ...
            btnVideoInPL.BackColor = _color;
            btnVideoInPL.ForeColor = _otherbackcolor;
            bindPlayListdepartmentstandardddl();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // Upload().Wait();
                ...
                string url = "../Admin/AddYoutubeVideo.aspx";
        ...
        //public async Task UploadNewVideo()
        //{
        //var value=  await Upload();
        //}
        ...
        //    {
        //        string credPath = "traineeUploadVideotoken.json";
        ...
        public void GetListOfPlayList(List<string> playListId)
        {
            var serviceEmail = "";
            var serviceOnEmailId = "";
            var privateKey = "";
            ...
            {
                foreach (var listId in playListId)
                {
                    if (listId == item.Id)
                    {
        ...
        protected void btnAddItemInPL_Click(object sender, EventArgs e)
        {
            ...
            btnVideoInPL.BackColor = _color;
            btnVideoInPL.ForeColor = _otherbackcolor;
            bindAddVideoInPlayListdepartmentstandardddl();
        ...
        protected void btnDeleteItemPL_Click(object sender, EventArgs e)
        {
            ...
            btnVideoInPL.BackColor = _color;
            btnVideoInPL.ForeColor = _otherbackcolor;
            bindRemoveVideoInPlayListdepartmentstandardddl();
            //bindDeleteItemPL();
        }
        public void bindDeleteItemPL(List<string> playlisttrainee)
        {
        ...
        public void bindAddItemPL(List<string> playlisttrainee)
        {
            List<ListOfPlayList> dt = new List<ListOfPlayList>();
            dt = GetAllListOfPlayList(playlisttrainee).ToList();
        ...
        public void bindPlayListdepartmentstandardddl()
        {
            DataTable dt = new DataTable();
            dt = deptbll.GetDepartmentStandardUnderTraineeList("Teacher");
            ddlPlayListDepartment.DataSource = dt;
            ddlPlayListDepartment.DataBind();
            ddlPlayListDepartment.DataTextField = "DepartmentStandardName";
            ddlPlayListDepartment.DataValueField = "Id";
            ddlPlayListDepartment.DataBind();
            ddlPlayListDepartment.Items.Insert(0, new ListItem("-- Select --", "0"));
        }
        public void bindAddVideoInPlayListdepartmentstandardddl()
        {
            DataTable dt = new DataTable();
            dt = deptbll.GetDepartmentStandardUnderTraineeList("Teacher");
            ddlAddVideoInPLDept.DataSource = dt;
            ddlAddVideoInPLDept.DataBind();
            ddlAddVideoInPLDept.DataTextField = "DepartmentStandardName";
            ddlAddVideoInPLDept.DataValueField = "Id";
            ddlAddVideoInPLDept.DataBind();
            ddlAddVideoInPLDept.Items.Insert(0, new ListItem("-- Select --", "0"));
        }
        public void bindRemoveVideoInPlayListdepartmentstandardddl()
        {
            DataTable dt = new DataTable();
            dt = deptbll.GetDepartmentStandardUnderTraineeList("Teacher");
            ddlRemoveVideoFromPLDept.DataSource = dt;
            ddlRemoveVideoFromPLDept.DataBind();
            ddlRemoveVideoFromPLDept.DataTextField = "DepartmentStandardName";
            ddlRemoveVideoFromPLDept.DataValueField = "Id";
            ddlRemoveVideoFromPLDept.DataBind();
            ddlRemoveVideoFromPLDept.Items.Insert(0, new ListItem("-- Select --", "0"));
        }

        protected void ddlPlayListDepartment_SelectedIndexChanged(object sender, EventArgs e)
        {
            List<string> playlistId = new List<string>();
            playlistId = videobll.GetPlayListByDeptId(int.Parse(ddlPlayListDepartment.SelectedValue));
            GetListOfPlayList(playlistId);
        }

        protected void ddlAddVideoInPLDept_SelectedIndexChanged(object sender, EventArgs e)
        {
            List<string> playlistId = new List<string>();
            playlistId = videobll.GetPlayListByDeptId(int.Parse(ddlAddVideoInPLDept.SelectedValue));
            bindAddItemPL(playlistId);
        }

        protected void ddlRemoveVideoFromPLDept_SelectedIndexChanged(object sender, EventArgs e)
        {
            List<string> playlistId = new List<string>();
            playlistId = videobll.GetPlayListByDeptId(int.Parse(ddlRemoveVideoFromPLDept.SelectedValue));
            bindDeleteItemPL(playlistId);
        }
        ...
        protected void btnVideoInPL_Click(object sender, EventArgs e)
        {
            ...
            string otherbackColor = "#ffffff";
            Color _otherbackcolor = System.Drawing.ColorTranslator.FromHtml(otherbackColor);
            btnVideoInPL.BackColor = _backcolor;
            btnVideoInPL.ForeColor = _txtcolor;
            btnUploadVideo.BackColor = _color;
            btnUploadVideo.ForeColor = _otherbackcolor;
            btnViewPlayList.BackColor = _color;
            btnViewPlayList.ForeColor = _otherbackcolor;
            ...
            btnDeleteItemPL.BackColor = _color;
            btnDeleteItemPL.ForeColor = _otherbackcolor;
            bindPlayVideoInPlayListdepartmentstandardddl();
        }
        public void bindPlayVideoInPlayListdepartmentstandardddl()
        {
            DataTable dt = new DataTable();
            dt = deptbll.GetDepartmentStandardUnderTraineeList("Teacher");
        ...
        protected void ddlvideodepartment_SelectedIndexChanged(object sender, EventArgs e)
        {
            List<string> playlistId = new List<string>();
            playlistId = videobll.GetPlayListByDeptId(int.Parse(ddlvideodepartment.SelectedValue));
            bindPlayVideoItemPL(playlistId);
        }

        protected void ddlvideoplaylistPL_SelectedIndexChanged(object sender, EventArgs e)
        {
            string Url = "https://www.youtube.com/embed?listType=playlist&list=" + ddlvideoplaylistPL.SelectedValue.ToString() + "";//"&index=" + labelPosition.Text +
        ...
        public void bindPlayVideoItemPL(List<string> playlisttrainee)
        {
            List<ListOfPlayList> dt = new List<ListOfPlayList>();
            dt = GetAllListOfPlayList(playlisttrainee).ToList();
            ddlvideoplaylistPL.DataSource = dt;
            ddlvideoplaylistPL.DataBind();
            ddlvideoplaylistPL.DataTextField = "Title";
            ddlvideoplaylistPL.DataValueField = "PlayListId";
            ddlvideoplaylistPL.DataBind();
            ddlvideoplaylistPL.Items.Insert(0, new ListItem("-- Select --", "0"));
        }
    }
}