<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/Lesson.master" AutoEventWireup="true" CodeBehind="UploadVideo.aspx.cs" Inherits="LMS.Trainee.UploadVideo" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8">
                ...
                <asp:Button class="btn btn-primary" ID="btnVideoInPL" runat="server" Text="Play Video In Play List" OnClick="btnVideoInPL_Click" />
            </div>
            <div class="col-sm-12">
                <asp:MultiView ID="MultiViewVideo" runat="server">
                    ...
                    <asp:View ID="ViewPlayList" runat="server">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Department/ Standard</label>
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlPlayListDepartment" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPlayListDepartment_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    ...
                    <asp:View ID="ViewAddItemInPL" runat="server">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Department/ Standard</label>
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlAddVideoInPLDept" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlAddVideoInPLDept_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlAddPlayList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAddPlayList_SelectedIndexChanged">
                                    </asp:DropDownList>
                    ...
                    <asp:View ID="ViewRemoveItemInPL" runat="server">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Department/ Standard</label>
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlRemoveVideoFromPLDept" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlRemoveVideoFromPLDept_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-4">
                    ...
                    <asp:View ID="ViewVideoInPL" runat="server">
                        <div class="row">
                            <div class="col-sm-12">
                                <br />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Department/ Standard</label>
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlvideodepartment" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlvideodepartment_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label>Select PlayList :</label>
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlvideoplaylistPL" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlvideoplaylistPL_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-4"></div>
