<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/Exam.master" AutoEventWireup="true" CodeBehind="ExamList.aspx.cs" Inherits="LMS.Trainee.ExamList" %>
...
<script type="text/javascript">
 ...
 <asp:Button ID="btnaddexam" CssClass="btn btn-primary" runat="server" Text="Add Exam" OnClick="btnaddexam_Click"/>&nbsp;&nbsp;&nbsp;
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color:#bae7e3">
                                    <span Font-Size="Medium" color="black"><b>Add Exam</b></span>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtDepartmentName" runat="server" placeholder="Exam Name"></asp:TextBox>
                                    </div>
...
<div class="col-md-flex"><asp:TextBox CssClass="form-control" ID="txtSearch" runat="server" placeholder="Enter Search Text" AutoPostBack="true" onkeyup="RefreshUpdatePanel();"></asp:TextBox>
</div>
<div class="col-md-flex">
                    &nbsp;&nbsp;&nbsp;
                </div>
          ...
          AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging"  OnRowDataBound="GridView1_RowDataBound">
                    <Columns>
                       <%-- <asp:BoundField HeaderText="Sr No." DataField="Id" ItemStyle-HorizontalAlign="Center" >
                        ...
                        <asp:BoundField HeaderText="Department / Standard" DataField="DepartmentStandardName" />--%>
...
<asp:TemplateField HeaderText="Publish" ItemStyle-HorizontalAlign="Center">
                    ...
                    <asp:TemplateField HeaderText="Course / Subject" >
                        <ItemTemplate>
                            <asp:Label ID="lblcoursename" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"CourseSubjectName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                        <%--<asp:BoundField HeaderText="Course / Subject" DataField="CourseSubjectName" />--%>
                    <asp:TemplateField HeaderText="Exam Name" >
                        <ItemTemplate>
                            <asp:Label ID="lblexamname" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ExamName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <asp:Panel ID="pnlpopup" runat="server"  Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row"  style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color:#bae7e3">
                               <table>
                                <tr>
                                <td height="50px"> <span Font-Size="Medium" color="black"><b>Update Exam</b></span> </td>
                                </tr>
                                </table>
                             </div>
                        </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                             <div class="col-sm-12" align="left">
                                ...
                                <asp:TextBox ID="txtname" CssClass="form-control" placeholder="Enter Exam Name" runat="server" />
                             </div>
                        </div>
                       <div class="row">
                            <div class="col-sm-12" align="left">
 ...
 <div class="row" style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color:#bae7e3">
                               <table>
                                <tr>
                                <td height="50px"> <span Font-Size="Medium" color="black"><b>Delete Exam</b></span> </td>
                                </tr>
                                </table>
                             </div>
                        </div>
                    <div style=" padding: 10px;box-shadow: 0px 0px 0px #888888;text-align:center;width:390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="center" >
                               <br>
                    <asp:Label runat="server" ID="lblDeleteTraineeExamId" Text="Label" Visible="false"></asp:Label>
                             </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="center" >
