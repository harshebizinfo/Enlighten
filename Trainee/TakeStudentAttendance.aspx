<%@ Page Title="" Language="C#" MasterPageFile="~/Trainee/AttendanceMaster.master" AutoEventWireup="true" CodeBehind="TakeStudentAttendance.aspx.cs" Inherits="LMS.Trainee.TakeStudentAttendance" %>
     ...
     <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <asp:DropDownList class="form-control" ID="ddlDivision" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtDate" class="form-control" runat="server" autoComplte="off" placeholder="Select Attendance DateTime" AutoPostBack="true" autocomplete="off" OnTextChanged="txtDate_TextChanged1"></asp:TextBox>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    Attendance:
                                    <asp:DropDownList ID="ddlAttendance" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
