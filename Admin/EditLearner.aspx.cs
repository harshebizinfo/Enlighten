...
namespace LMS.Admin
{
    public partial class EditLearner : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                var editApplicationUserLearnerId = Session["EditLearnerApplicationUserId"].ToString();
        ...
        protected void Button9_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sdm.FatherContactNumber = txtFatherContactNumber.Text;
                sdm.PresentAddess = "";
                sdm.PresentCity = "";
                sdm.PresentState = "";
                ...
                if (result > 0)
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Student Updated Sucessfully')", true);
                }
                else
                {
