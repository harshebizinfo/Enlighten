<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/DepartmentStandard.master" AutoEventWireup="true" CodeBehind="StudentInDepartmentList.aspx.cs" Inherits="LMS.Admin.StudentInDepartmentList" %>
 ...
 <div class="row">
            ...
            <div class="breadcrumb col-sm-12" style="width: 100%">
                <div class="col-sm-flex">
                    <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Add Student In Department" OnClick="Button1_Click"  />
                    &nbsp;&nbsp;&nbsp;
                </div>
                <div class="col-sm-flex">
                ...
                <div class="col-md-flex form-group">
...
<asp:DropDownList ID="ddlDepartment" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged"></asp:DropDownList>
</div>
</div>
<div class="col-sm-4">
<label>Student</label>
<div class="form-group">
<asp:DropDownList ID="ddlStudent" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStudent_SelectedIndexChanged"></asp:DropDownList>
</div>
</div>
</div>
        <div class="row">
                           ...
                           <asp:TemplateField HeaderText="Category">
                            ...
                            <asp:TemplateField HeaderText="Area">
                             ...
                             <asp:TemplateField HeaderText="Conveyance">
                                <ItemTemplate>
                                    <asp:Label ID="lblhasConveyance" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"HasConveyance").ToString()=="True"?"Active":"InActive" %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Vehicle">
                                <ItemTemplate>
                                    <asp:Label ID="lblVehicleMode" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"VehicleName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField> 
                             <asp:TemplateField HeaderText="Pick Up Vehicle">
                                <ItemTemplate>
                                    <asp:Label ID="lblPickUpVehicle" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PickUpVehicleNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Drop Vehicle">
                                <ItemTemplate>
                                    <asp:Label ID="lblDropVehicle" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DropVehicleNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField> 
                    ...
                    <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                        <div class="row" style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                                <table>
                                    <tr>
                                        <td height="50px"><span font-size="Medium" color="black"><b>Delete Student From Department</b></span> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <div style="padding: 10px; box-shadow: 0px 0px 0px #888888; text-align: center; width: 390px" backcolor="White">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8" align="left">
                                    <asp:Button ID="Button2" CssClass="btn btn-success float-end" BorderColor="White" ForeColor="White" CommandName="Delete" runat="server" Text="Yes" OnClick="btnDelete_Click" />
