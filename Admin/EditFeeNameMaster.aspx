<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FeesMaster.master" AutoEventWireup="true" CodeBehind="EditFeeNameMaster.aspx.cs" Inherits="LMS.Admin.EditFeeNameMaster" %>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="reqFavoriteColor" Text="Select Fee Group" InitialValue="0" ValidationGroup="ddlFeeGroup" ControlToValidate="ddlFeeGroup" runat="server" ForeColor="Red" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
                <table>
                    <tr>
                        <td>
                            <asp:CheckBox ID="chkRefundable" runat="server" />&nbsp;&nbsp;&nbsp;<label>Refundable Fee</label></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:CheckBox ID="chkoptional" runat="server" />&nbsp;&nbsp;&nbsp;<label>Optional Fee</label></td>
                    </tr>
                    <tr>
                        <td>
