<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/TransportMaster.master" AutoEventWireup="true" CodeBehind="TransportFee.aspx.cs" Inherits="LMS.Admin.TransportFee" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color: #bae7e3">
                                    <span font-size="Medium" color="black"><b>Add Transport Fee</b></span>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <asp:DropDownList CssClass="form-control" ID="ddlareaMaster" runat="server"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="reqFavoriteColor" Text="Select Area" InitialValue="0" ValidationGroup="AddTransportFee" ControlToValidate="ddlareaMaster" runat="server" ForeColor="Red" />
                                    </div>
                                    <div class="mb-3">
                                        <asp:DropDownList CssClass="form-control" ID="ddlTransportMode" runat="server"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Text="Select Vehicle Mode" InitialValue="0" ValidationGroup="AddTransportFee" ControlToValidate="ddlTransportMode" runat="server" ForeColor="Red" />
                                    </div>
                                    <div class="mb-3">
                                        <%--<label class="form-label">Department / Standard Name</label>--%>
                                        <asp:TextBox CssClass="form-control" ID="txtDivisionName" runat="server" TextMode="Number" placeholder="Transport Fee"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Enter Transport Fee Amount" ForeColor="Red" Text="*" ControlToValidate="txtDivisionName" ValidationGroup="AddTransportFee"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="modal-footer" style="justify-content: flex-start;">
                                    <div class="">
                                        <asp:Button class="btn btn-block" ID="Button9" runat="server" CssClass="btn btn-success float-end" Style="background-color: #28a745; color: #fff" Text="Submit" ValidationGroup="AddTransportFee" OnClick="Button9_Click" />
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Vehicle">
                            <ItemTemplate>
                                <asp:Label ID="lblTransportModename" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"VehicleName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Fee">
                            <ItemTemplate>
                                <asp:Label ID="lbldepartmentname" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"TransportAmount") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlpopup" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Update Transport Fee</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div style="padding: 10px; box-shadow: 0px 0px 0px #888888; text-align: center; width: 390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                ...
                                <asp:TextBox ID="txtname" CssClass="form-control" placeholder="Enter Transport Fee" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Transport Fee Amount" ForeColor="Red" Text="*" ControlToValidate="txtname" ValidationGroup="UpdateTransportFee"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" align="left">
                                <asp:Button ID="btnUpdate" CssClass="btn btn-success float-end" ValidationGroup="UpdateTransportFee" BackColor="#28a745" BorderColor="white" ForeColor="White" CommandName="Update" runat="server" Text="Update" OnClick="btnUpdate_Click" />
                ...
                <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Delete Transport Fee</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
