<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FeesMaster.master" AutoEventWireup="true" CodeBehind="FeeStructure.aspx.cs" Inherits="LMS.Admin.FeeStructure" %>
        ...
        <div class="row">
            <div class="breadcrumb col-sm-12" style="width: 100%">
               <%-- <div class="col-sm-flex">
                    <asp:Button ID="btnAddVehicle" CssClass="btn btn-primary" runat="server" Text="Add Fee Structure" OnClick="btnAddVehicle_Click" />
                    &nbsp;&nbsp;&nbsp;
                </div>--%>
                <div class="col-sm-flex">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Standard">
                                <ItemTemplate>
                                    <asp:Label ID="lblStandard" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DepartmentStandardName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Fee Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblFeeName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FeeName").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Month">
                                <ItemTemplate>
                                    <asp:Label ID="lblMonth" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FeeMonth").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                    <asp:Label ID="lblFeeNameAmount" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FeeNameAmount").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Category Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblCategoryName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"CategoryName").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="pnlpopup" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Update Structure Fee</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div style="padding: 10px; box-shadow: 0px 0px 0px #888888; text-align: center; width: 390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                ...
                                <asp:TextBox ID="txtname" CssClass="form-control" placeholder="Enter Fee Amount" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Text="Enter Fee Amount" ValidationGroup="updateFeeStructure" ControlToValidate="txtname" runat="server" ForeColor="Red" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" align="left">
                                <asp:Button ID="btnUpdate" CssClass="btn btn-success float-end" BackColor="#28a745" BorderColor="white" ValidationGroup="updateFeeStructure" ForeColor="White" CommandName="Update" runat="server" Text="Update" OnClick="btnUpdate_Click" />
                                <asp:Button ID="Button2" runat="server" Text="Cancel" class="btn btn-danger float-end" BackColor="#dc3545" BorderColor="white" ForeColor="White" />
                            </div>
                        </div>
                    </div>
                </asp:Panel>
                    ...
                    <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                        <div class="row" style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                                <table>
                                    <tr>
                                        <td height="50px"><span font-size="Medium" color="black"><b>Delete Fee Structure</b></span> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
