<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FeesMaster.master" AutoEventWireup="true" CodeBehind="AddCategoryMaster.aspx.cs" Inherits="LMS.Admin.AddCategoryMaster" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color: #bae7e3">
                                    <span font-size="Medium" color="black"><b>Add Category</b></span>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtcategoryName" runat="server" placeholder="Category Name"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Category Name" ForeColor="Red" Text="*" ControlToValidate="txtcategoryName" ValidationGroup="Addcategory"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-3">
                                        <%--<label class="form-label">Department / Standard Name</label>--%>
                                        <asp:TextBox CssClass="form-control" ID="txtCategoryDescription" runat="server" placeholder="Category Description"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Category Description" ForeColor="Red" Text="*" ControlToValidate="txtCategoryDescription" ValidationGroup="Addcategory"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="modal-footer" style="justify-content: flex-start;">
                                    <div class="">
                                        <asp:Button class="btn btn-block" ID="Button9" runat="server" CssClass="btn btn-success float-end" Style="background-color: #28a745; color: #fff" Text="Submit" ValidationGroup="Addcategory" OnClick="Button9_Click" />
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblCategoryName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"CategoryName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlpopup" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Update Category</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div style="padding: 10px; box-shadow: 0px 0px 0px #888888; text-align: center; width: 390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                ...
                                <asp:TextBox ID="txteditcategoryName" CssClass="form-control" placeholder="Enter Name" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Category Name" ForeColor="Red" Text="*" ControlToValidate="txteditcategoryName" ValidationGroup="Editcategory"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                <label class="form-label">Category Description</label>
                                <asp:TextBox ID="txteditcategoryDescription" CssClass="form-control" placeholder="Enter Description" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Category Description" ForeColor="Red" Text="*" ControlToValidate="txteditcategoryDescription" ValidationGroup="Editcategory"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" align="left">
                                <asp:Button ID="btnUpdate" CssClass="btn btn-success float-end" BackColor="#28a745" ValidationGroup="Editcategory" BorderColor="white" ForeColor="White" CommandName="Update" runat="server" Text="Update" OnClick="btnUpdate_Click" />
