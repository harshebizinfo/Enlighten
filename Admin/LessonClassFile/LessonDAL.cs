    ...
    public class LessonDAL
    {
        ...
        public DataTable GetLessonListUnderDeptCourse(int deptId,int courseId)
        {
            try
            {
                connection1 = objdal01.Conncetion();
                SqlConnection con1 = new SqlConnection(connection1);
                strsqlquery = "GetLessonListUnderDeptCourse";
                if (con1.State != ConnectionState.Open)
                {
                    con1.Open();
                }
        ...
        public int AddNewLesson(int departmentStandardId, int coursesubjectId, string lessonTitle, string lessonDescription, Boolean ispublished)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@lessonDescription", lessonDescription);
