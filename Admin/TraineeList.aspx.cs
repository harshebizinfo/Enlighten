...
namespace LMS.Admin
{
    public partial class TraineeList : System.Web.UI.Page
    {
        ...
        private void BindGrid(string p)
        {
            ...
            dt = bll.GetTraineeApplicationUserList();
            DataView DataView = dt.DefaultView;
            DataView.RowFilter = "FirstName LIKE '%" + search + "%' OR LastName LIKE '%" + search + "%'  OR EmailId LIKE '%" + search + "%'  OR ContactNumber LIKE '%" + search + "%' OR DepartmentStandardName LIKE '%" + search + "%' OR CourseSubjectName LIKE '%" + search + "%'";
        ...
        {
            Response.Redirect("AddTrainee1.aspx");
        }
        ...
        private void ExportGridView()
        {
            ...
            string attachment = "attachment; filename=TraineeList.xls";
            ...
            string headerTable = @"<Table><tr><td colspan='8' align='center'><font size='7'>Trainee List</font></td></tr>
                                        <tr><td colspan='8'></td></tr></Table>";
            Response.Write(headerTable);
            Response.Write(sw.ToString());
            string footerTable = @"<Table><tr><td colspan='8'></td></tr><tr><td colspan='3' align='left'><b>Report By :</b>" + userName + "</td><td></td><td></td><td colspan='3' align='right'><b>Date :</b>" + DateTime.Now.ToString("dd-MM-yyyy") + "</td></tr></Table>";
        ...
        protected void imgbtn_Click(object sender, EventArgs e)
        {
            ...
            Session["EditTraineeApplicationUserId"] = id;
            Response.Redirect("EditTrainee.aspx");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                int traineeId = int.Parse(lblDeleteTraineeId.Text);
                var result = bll.DeleteApplicationUser(traineeId);
                if (result > 0)
                {
