<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Division.master" AutoEventWireup="true" CodeBehind="AddDivision.aspx.cs" Inherits="LMS.Admin.AddDivision" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color: #bae7e3">
                                    <span font-size="Medium" color="black"><b>Add Division</b></span>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtDivisionName" runat="server" placeholder="Division Name"></asp:TextBox>
                                    </div>
                                    <div class="mb-3">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Division">
                            <ItemTemplate>
                                <asp:Label ID="lbldepartmentname" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Section") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlpopup" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Update Division</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div style="padding: 10px; box-shadow: 0px 0px 0px #888888; text-align: center; width: 390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                ...
                                <asp:TextBox ID="txtname" CssClass="form-control" placeholder="Enter Division Name" runat="server" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="left">
                ...
                <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Delete Division</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
