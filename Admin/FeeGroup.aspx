<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FeesMaster.master" AutoEventWireup="true" CodeBehind="FeeGroup.aspx.cs" Inherits="LMS.Admin.FeeGroup" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color: #bae7e3">
                                    <span font-size="Medium" color="black"><b>Add Fee Group</b></span>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtFeeGroupName" runat="server" placeholder="Fee Group Name"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Enter Fee Group Name" ForeColor="Red" Text="*" ControlToValidate="txtFeeGroupName" ValidationGroup="AddFeeGroup"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="modal-footer" style="justify-content: flex-start;">
                                    <div class="">
                                        <asp:Button class="btn btn-block" ID="Button9" runat="server" CssClass="btn btn-success float-end" ValidationGroup="AddFeeGroup" Style="background-color: #28a745; color: #fff" Text="Submit" OnClick="Button9_Click" />
                ...
                <asp:Panel ID="pnlpopup" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Update Fee Group</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div style="padding: 10px; box-shadow: 0px 0px 0px #888888; text-align: center; width: 390px" backcolor="White">
                        ...
                        <div class="row">
                            <div class="col-sm-12" align="left">
                                <label class="form-label">Fee Group Name</label>
                                <asp:TextBox ID="txtname" CssClass="form-control" placeholder="Enter Fee Group Name" runat="server" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12" align="left">
                ...
                <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Delete Fee Group</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
