<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FeesMaster.master" AutoEventWireup="true" CodeBehind="FeeType.aspx.cs" Inherits="LMS.Admin.FeeType" %>
        ...
        <div class="row">
            <div class="breadcrumb col-sm-12" style="width: 100%">
               <%-- <div class="col-sm-flex">
                    <asp:Button ID="btnAddVehicle" CssClass="btn btn-primary" runat="server" Text="Add Fee Type" OnClick="btnAddVehicle_Click" />
                    &nbsp;&nbsp;&nbsp;
                </div>--%>
                <div class="col-sm-flex">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Due Date">
                                <ItemTemplate>
                                    <asp:Label ID="lblDueDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DueDate").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Late Fee">
                                <ItemTemplate>
                                    <asp:Label ID="lblLateFee" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"LateFee").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                        <div class="row" style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                                <table>
                                    <tr>
                                        <td height="50px"><span font-size="Medium" color="black"><b>Delete Fee Type</b></span> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
