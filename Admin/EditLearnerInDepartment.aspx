<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/DepartmentStandard.master" AutoEventWireup="true" CodeBehind="EditLearnerInDepartment.aspx.cs" Inherits="LMS.Admin.EditLearnerInDepartment" %>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <asp:DropDownList class="form-control" ID="ddllessonDepartment" runat="server" AutoPostBack="true" readonly="true" OnSelectedIndexChanged="ddllessonDepartment_SelectedIndexChanged">
                            </asp:DropDownList>
                    ...
                    <div class="col-sm-4" runat="server">
                        ...
                        <div class="form-group">
                            <asp:DropDownList class="form-control" ID="ddlDivision" runat="server" AutoPostBack="True" readonly="true">
                            </asp:DropDownList>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <asp:DropDownList class="form-control" ID="ddlStudentCourse" runat="server" readonly="true">
                            </asp:DropDownList>
