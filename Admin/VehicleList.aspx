<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/TransportMaster.master" AutoEventWireup="true" CodeBehind="VehicleList.aspx.cs" Inherits="LMS.Admin.VehicleList" %>
        ...
        <div class="row">
            <div class="breadcrumb col-sm-12" style="width: 100%">
                <div class="col-sm-flex">
                    <asp:Button ID="btnAddVehicle" CssClass="btn btn-primary" runat="server" Text="Add Vehicle" OnClick="btnAddVehicle_Click" />
                    &nbsp;&nbsp;&nbsp;
                </div>
                <div class="col-sm-flex">
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Vehicle Mode">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Vehicle Number">
                            <ItemTemplate>
                                <asp:Label ID="lblVehicleNumber" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"VehicleNumber") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Description">
                            <ItemTemplate>
                                <asp:Label ID="lblVehicleDescription" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"VehicleDescription") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Pick Up Driver Name">
                            <ItemTemplate>
                                <asp:Label ID="lblPickUpDriverName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PickUpDriverName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                     <%--   <asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblPickUpDriverAddress" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PickUpDriverAddress") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderText="Pick Up Driver Contact Number">
                            <ItemTemplate>
                                <asp:Label ID="lblPickUpDriverContactNumber" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PickUpDriverContactNumber") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--<asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblPickUpDriverAdhaarNumber" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PickUpDriverAdhaarNumber") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderText="Drop Driver Name">
                            <ItemTemplate>
                                <asp:Label ID="lblDropDriverName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DropDriverName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                       <%-- <asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblDropDriverAddress" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DropDriverAddress") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderText="Drop Driver Contact Number">
                            <ItemTemplate>
                                <asp:Label ID="lblDropDriverContactNumber" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DropDriverContactNumber") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--<asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblDropDriverAdhaarNumber" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DropDriverAdhaarNumber") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                ...
                <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Delete Registered Vehicle</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
