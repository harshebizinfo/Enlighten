<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/TransportMaster.master" AutoEventWireup="true" CodeBehind="AllotedVehicleList.aspx.cs" Inherits="LMS.Admin.AllotedVehicleList" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header" style="background-color: #bae7e3">
                                    <span font-size="Medium" color="black"><b>Assign vehicle to Area</b></span>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Text="Select Vehicle" InitialValue="0" ValidationGroup="AddTransportFee" ControlToValidate="ddlTransportMode" runat="server" ForeColor="Red" />
                                    </div>
                                    <%--<div class="mb-3">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Vehicle">
                            <ItemTemplate>
                                <asp:Label ID="lblTransportModename" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"VehicleNumber") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                    <div class="row" style="margin: 0px 0px -20px 0px">
                        <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                            <table>
                                <tr>
                                    <td height="50px"><span font-size="Medium" color="black"><b>Delete Alloted Vehicle</b></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
