<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Teacher.master" AutoEventWireup="true" CodeBehind="TraineeList.aspx.cs" Inherits="LMS.Admin.TraineeList" %>
        ...
        <div class="row">
            <div class="breadcrumb col-sm-12" style="width: 100%">
                <div class="col-sm-flex">
                    ...
                    <asp:Button ID="btnAddTeacher" CssClass="btn btn-primary" runat="server" Text="Add Teacher" OnClick="btnAddTeacher_Click" />
                ...
                <%--<div class="col-sm-flex">
                    <asp:Button ID="btnListDelete" CssClass="btn btn-primary" runat="server" Text="Delete" OnClick="btnListDelete_Click" />&nbsp;&nbsp;&nbsp;  AutoPostBack="true" onkeyup="RefreshUpdatePanel();"
                </div>--%>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Subject" DataField="CourseSubjectName" />
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="LkB1" runat="server" Text="Edit" CssClass="btn btn-success"  CommandName="EditRow" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ApplicationUserId") %>' OnClick="imgbtn_Click"></asp:LinkButton><%--<i class="fa fa-pencil-square-o" style="color:navy;font-size:25px"></i>--%>
                                    <asp:LinkButton ID="LkB2" runat="server" Text="Delete" CssClass="btn btn-danger" CommandName="DeleteRow" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ApplicationUserId") %>' OnClick="imgdeletebtn_Click"></asp:LinkButton><%--<i class="fa fa-trash" style="color:red;font-size:20px"></i>--%>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
                    ...
                    <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                        <div class="row" style="margin: 0px 0px -20px 0px">
                            <div class="col-sm-12" align="left" style="background-color: #bae7e3">
                                <table>
                                    <tr>
                                        <td height="50px"><span font-size="Medium" color="black"><b>Delete Trainee</b></span> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
