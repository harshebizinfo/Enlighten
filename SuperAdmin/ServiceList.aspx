<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/ServiceAccountMaster.master" AutoEventWireup="true" CodeBehind="ServiceList.aspx.cs" Inherits="LMS.SuperAdmin.ServiceList" %>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Client Id">
                                    <ItemTemplate>
                                        <asp:Label ID="lblClientid" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ClientIdName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Service Account Email" DataField="ServiceAccountEmail" />
                                <asp:BoundField HeaderText="Email ID" DataField="UserEmail" />
                                <%--<asp:BoundField HeaderText="Private Key" DataField="PrivateKey" />--%>
                        ...
                        <asp:Panel ID="pnlpopuptwo" runat="server" Width="400px" BackColor="White" Style="display: none; padding-top: 0px; padding-left: 0px; border: 0px solid white; border-radius: 5px; height: auto; margin-top: -10%; transition: transform 200ms ease; z-index: 20;">
                            <div class="row" style="margin:0px 0px -20px 0px">
                                    <div class="col-sm-12" align="left" style="background-color:#bae7e3">
                                        <table>
                                            <tr>
                                                <td height="50px"><span font-size="Medium" color="black"><b>Delete Service File</b></span> </td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
