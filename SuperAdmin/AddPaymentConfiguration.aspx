<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/Payment.master" AutoEventWireup="true" CodeBehind="AddPaymentConfiguration.aspx.cs" Inherits="LMS.SuperAdmin.AddPaymentConfiguration" %>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <asp:DropDownList ID="ddlClient" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlClient_SelectedIndexChanged"></asp:DropDownList>
